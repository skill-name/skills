...
- **[add-datatest-id](./skills/engineering/add-datatest-id/SKILL.md)** — Add stable, semantic, unique test selectors (`data-testid`, `data-test`, `data-cy`) across any frontend project without changing application behavior. Detects framework and existing convention before adding missing IDs.
